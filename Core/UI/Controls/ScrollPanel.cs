...
public class ScrollPanel : Panel {
    ...
    protected override void UpdateInput() {
        ...
        if (HasScrollableContentV()) {
            ...
            if (!_isDraggingScrollbarV && overTrackV && InputManager.IsMouseButtonJustPressed(MouseButton.Left, ignoreConsumed: true)) {
                if (isOverThumb) {
        ...
        if (HasScrollableContentH()) {
            ...
            if (!_isDraggingScrollbarH && overTrackH && InputManager.IsMouseButtonJustPressed(MouseButton.Left, ignoreConsumed: true)) {
                if (isOverThumb) {
